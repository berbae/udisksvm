...
app = QtWidgets.QApplication(['traydvm'])
...
ICON_THEME = '/usr/share/icons/oxygen/base/32x32'
...
trayicon = QtWidgets.QSystemTrayIcon(icon_name)

# Popup menu creation
traypopup = QtWidgets.QMenu()

popuptitle = QtWidgets.QWidgetAction(traypopup)
